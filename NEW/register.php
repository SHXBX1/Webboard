        ...
        <div class="row mt-4">
            ...
            <div class="col-lg-6">
                ...
                if (isset($_SESSION['add_login'])) {
                    ...
                    } elseif ($_SESSION['add_login'] == 'notmatch') {
                        echo "<div class='alert alert-danger'>รหัสผ่านไม่ตรงกัน</div>";
                    } else {
            ...
            <div class="row mt-2">
                <div class="col-sm-10 col-md-8 col-lg-6 mx-auto">
                    <div class="card border-primary">
                        <form action="register_save.php" method="post" onsubmit="return Matchpassword()">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-9">
                                        <input id="pwd2" type="password" name="pwd2" class="form-control" onblur="Matchpassword()"required>
                                    </div>
                                </div>
                                <div class="row mb-3">
